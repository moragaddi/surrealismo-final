...
<main class="main-inicio">
            <div class="banner"> 
              <h2 class="banner-titulo">REGISTRATE</h2>
              <h3 class="creado">Usuario no registrado</h3>
            </div>
            ...
            <form class="form" method= "POST" action="registro.php">
                <div class="input-group">
                    ...
                    <input type="text" name="nombre" id="name" style="width: 95%">
                </div>
                <div class="input-group">
                ...
                <div class="input-group">
                    ...
                    <input type="text" name="clave" id="password" style="width: 95%">
                </div>
            ...
            <p class="signup">¿Ya tenes una cuenta?
                <a rel="noopener noreferrer" href="login.html" class="">Inicia sesión</a>
            </p>
        </div>
        </main>
  </body>
