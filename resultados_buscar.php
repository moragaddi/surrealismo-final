...
<article>
    ...
    <?php	
			...
			echo "<div style= 'width:60%; float:right; margin-top:-280px'>". $resultados['bio'] . "</div> ";
            echo "<div style= 'width:20%; float:left; margin-bottom:18;'>".$resultados['foto'] . "</div>";
